...
import 'package:widgetsproject/Text.dart';
import 'package:widgetsproject/Widgets/cliprrectwidget.dart';
import 'package:widgetsproject/Widgets/listviewbuilder.dart';
import 'package:widgetsproject/Widgets/materialbtn.dart';
import 'package:widgetsproject/Widgets/textwidget.dart';
...
class _HomeState extends State<Home> {
  bool teacherbgcolor = false;
  bool teachertxtcolor = false;
  bool studentbgcolor = false;
  bool studenttxtcolor = false;
  bool value = true;
  @override
    ...
    return Row(
      ...
      children: [
        Materialbutton(
          onPressed: () {
            setState(() {
              ...
              studenttxtcolor = !studenttxtcolor;
            });
          },
          color: studentbgcolor ? Colors.green[700] : Colors.white,
          child: Textwidget(
            text: student,
            fontSize: 25.sp,
            color: studenttxtcolor ? Colors.white : Colors.black,
          ),
          height: 60.sp,
          minWidth: 150.sp,
        ),
        Materialbutton(
          onPressed: () {
            setState(() {
              teacherbgcolor = !teacherbgcolor;
              teachertxtcolor = !teachertxtcolor;
            });
          },
          color: teacherbgcolor ? Colors.white : Colors.green[700],
          child: Textwidget(
            text: teacher,
            fontSize: 25.sp,
            color: teachertxtcolor ? Colors.black : Colors.white,
          ),
          height: 60.sp,
          minWidth: 150.sp,
        ),
                  ...
                  children: [
                    Padding(
                      ...
                      child: Column(
                        ...
                        children: [
                          Textwidget(
                            text: 'Lecture of english in class 10',
                            fontSize: 20.sp,
